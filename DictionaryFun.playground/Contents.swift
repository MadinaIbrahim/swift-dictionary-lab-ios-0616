...
var stateWithCapitalDictionary = ["New York":"Albany",
                                  "Ohio":"Columbus",
                                  "Florida":"Tallahassee",
                                  "Georgia":"Atlanta",
                                  "Kentucky":"Frankfort"]
 ...
 */
///  'stateWithCapitalDictionary' is with keys type of String and value type of String.
/*: question3
 ### 3. Create a variable called `capital` and assign to it Florida's capital from the dictionary.
 */
var capital = stateWithCapitalDictionary["Florida"]
/*: question4
 ### 4. Unwrap `capital` and print out the message "The capital of Florida is <Capital>" to the console.
 */
if let capitalOfFlorida = stateWithCapitalDictionary["Florida"] {
...
// write your code here
var anotherCapital = ""
   stateWithCapitalDictionary["Pennsylvania"] = anotherCapital
/*: question6
 ### 6. Unwrap `anotherCapital` and print out the message "I don't know Pennsylvania's capital" to the console.
 */
if let anotherCapital = stateWithCapitalDictionary["Pennsylvania"] {
    print("I don't know Pennsylvannia's capital.")
}
/*: question7
 ### 7. Pennsylvania's capital is Harrisburg. Add it to your state capitals dictionary.
 */
stateWithCapitalDictionary["Pennsylvannia"] = "Harrisburg"
/*: question8
 ...
 */
if let capitalOfPennsylvannia = stateWithCapitalDictionary["Pennsylvannia"] {
    print("Pennsylvannia's capital is \(capitalOfPennsylvannia)")
/*: question9
 ...
 */
stateWithCapitalDictionary.removeValueForKey("Pennsylvannia")
    print("\(stateWithCapitalDictionary)")
/*: question10
...
let state = "New York"
// write your code here
if let capitalOfNewYork = stateWithCapitalDictionary[state] {
 ...
 */
let bandsWithMembers = [ "Nirvana": ["Kurt Cobain", "Krist Novoselic", "Dave Grohl"],
                        "The Beatles":["John Lennon", "George Harrison", "Paul McCartney", "Ringo Starr"],
                        "The Breeders":["Kim Deal", "Kelley Deal", "Josephine Wiggs", "Jim Macpherson"],
                        "Pixies":["Frank Black", "Joey Santiago", "Kim Deal", "David Lovering"]]
/*: question12
 ...
 */
/// dictionary bandsWithMembers has keys type of String and values type of Array with Strings
/*: question13
...
let bandName = "Pixies"
// write your code here
if let membersOfPixies = bandsWithMembers[bandName] {
    print("\(membersOfPixies)")
}
/*:
 [Solution](solution)
 */
